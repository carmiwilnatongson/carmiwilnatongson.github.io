<script>
    ...
    export let tabs = [
        ...
        { name: "Contact", link: "https://www.facebook.com/carmitongson" },
        // { name: "Contact", link: "" },
        // {name: '', link: ''},
    ];
</script>
...
<header
    class={"sticky z-[10] top-0 duration-200 px-6 flex items-center justify-between border-b border-solid " +
        (y > 0
            ? " py-4 bg-blue-950 border-pink-950"
            : " py-6 bg-transparent border-transparent")}
>
    <h1 class="font-medium">
        <b class="font-bold poppins">Carmi Wilna</b> <span class="">Tongson</span>
    </h1>
    <div class="sm:flex items-center gap-4 hidden">
        ...
        {/each}
        <button
            class="blueShadow relative overflow-hidden px-5 py-2 group rounded-full bg-white text-blue-950"
        >
            <div
